...
void Vp9InitMbmodeProbs(struct Vp9Decoder *x)
{
    ...
    for(i = 0; i < VP9_INTRA_MODES; i++)
    {
        ...
        {
            memcpy(x->entropy.kf_bmode_prob[i][j], vp9_kf_default_bmode_probs[i][j],8);
...
const vp9_tree_index vp9hwd_intra_mode_tree[VP9_INTRA_MODES * 2 - 2] = {
    -DC_PRED, 2,            /* 0 = DC_NODE */
    -TM_PRED, 4,            /* 1 = TM_NODE */
    -V_PRED, 6,             /* 2 = V_NODE */
    8, 12,                  /* 3 = COM_NODE */
...
const vp9_tree_index vp9hwd_partition_tree[6] = {
    -PARTITION_NONE, 2, -PARTITION_HORZ, 4, -PARTITION_VERT, -PARTITION_SPLIT};

const vp9_tree_index vp9hwd_switchable_interp_tree[VP9_SWITCHABLE_FILTERS * 2 -
                                                2] = {-0, 2, -1, -2};
