...
typedef enum VENC_VIDEO_GOP_MODE {
    AW_NORMALP       = 0,                 //one p ref frame
    AW_DOUBLEP       = 1,                 //double p ref frames
    AW_SMARTP        = 2,                 //double p ref frames and use virtual i frame
}VENC_VIDEO_GOP_MODE;
...
typedef struct VencOverlayCoverYuvS {
     //1:use the cover yuv; 0:transform the argb data to yuv and cover
